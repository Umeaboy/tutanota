...
import { CreditCardViewModel } from "./CreditCardInputModel.js"
...
export class SimplifiedCreditCardInput implements Component<SimplifiedCreditCardAttrs> {
	...
	private renderCcNumberHelpLabel(model: CreditCardViewModel): Children {
	...
	private renderCvvNumberHelpLabel(model: CreditCardViewModel): Children {
